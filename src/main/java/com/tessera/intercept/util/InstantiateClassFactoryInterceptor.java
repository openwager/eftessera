...
public class InstantiateClassFactoryInterceptor
	extends ClassFactoryInterceptorSupport
{
	public
	InstantiateClassFactoryInterceptor (final Map<String, String> props)
	{
		super (props); 
		return; 
	}
	...
	interface PROP
		extends ClassFactoryInterceptorSupport.PROP
	{
